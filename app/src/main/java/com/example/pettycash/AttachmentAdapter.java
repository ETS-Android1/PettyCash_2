...
public class AttachmentAdapter extends RecyclerView.Adapter<AttachmentAdapter.ViewHolder> {
    ...
    public AttachmentAdapter(Context context, List<Uri> docList, AddLine addLine ) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            if (linePos != -1) {
                ...
                Picasso.get().load(docList.get(position)).into(holder.image);
            }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void onClick(View v) {
            ...
            ImageFragment imageFragment = new ImageFragment(docList.get(getAdapterPosition()));
